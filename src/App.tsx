  ...
  return (
    <div className='main-screen'>
      <div className='main-screen__content'>
        <h1>Приложение для организации похода</h1>
        <h2>Условие: введите имя участника похода и выберите календарные дни, в которые данный участник готов пойти в поход.</h2>
        <h2>Поход длится 3 дня, поэтому приложение составляет список, в котором у 2х и более участников совпадают 3 свободных дня подряд.</h2>
        <PersonForm 
          name={name}
          error={error}
